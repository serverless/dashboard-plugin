...
describe('frameworkVersionPolicy', () => {
  ...
  it('forbids if exact version does not match', () => {
    expect(() => frameworkVersionPolicy(policy, { frameworkVersion: '1.37.1' }, '1.37.0')).toThrow(
  ...
  it('forbids if version range does not match', () => {
    expect(() => frameworkVersionPolicy(policy, { frameworkVersion: '1.37.1' }, '<1.37.1')).toThrow(
