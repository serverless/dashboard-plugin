 ...
 */
export const wrapNodePy = (fn, ctx) => {
...
export default async ctx => {
  ...
  // Copy SDK
  if (Object.values(ctx.state.functions).some(({ runtime }) => runtime.includes('nodejs'))) {
  ...
  if (Object.values(ctx.state.functions).some(({ runtime }) => runtime.includes('python'))) {
...
module.exports.wrapNodeJs = wrap;
