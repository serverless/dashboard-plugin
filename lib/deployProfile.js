...
module.exports.configureDeployProfile = async (ctx) => {
  ...
  if (parameterizedArgs.length) {
    ...
    ctx.sls.logDeprecation(
      ...
      `Cannot parameterize "${names}" please use plaintext or pass arguments via command line options. More info: https://www.serverless.com/framework/docs/deprecations/#PARAMETERIZED_ARGUMENT\nReceived-\n${parameterizedArgs
