...
describe('interactiveCli: register', function() {
  ...
  before(async () => {
    ...
    modulesCacheStub = {
      ...
      [cjsResolve(dashboardPluginPath, './lib/deployProfile').realPath]: {
        configureDeployProfile: async () => {},
      },
      [cjsResolve(dashboardPluginPath, './lib/interactiveCli/set-app')
        .realPath]: setAppConfiguration,
      [cjsResolve(dashboardPluginPath, '@serverless/platform-sdk').realPath]: platformSdkStub,
    };
