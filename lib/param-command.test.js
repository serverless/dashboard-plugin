...
describe('paramCommand', () => {
  ...
  describe('list', () => {
    it('Should support `--org` and `--app` CLI params', async () => {
      ...
      expect(output).to.include('consoleInstance');
      expect(output).to.include('consoleInstanceValue');
      expect(output).to.include('consoleService');
      expect(output).to.include('consoleServiceValue');
    });
